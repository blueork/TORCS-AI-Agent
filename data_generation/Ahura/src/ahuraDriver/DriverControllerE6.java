...
//		OpponentController1.relativeSpeedUpdater(noiseCan);
		...
		int currentGear = noiseCan.getGear();
...
//        FileWriter fw = null;
//        try {
//            fw = new FileWriter("E:\\University\\Semester_6\\CS_AI2002-Artificial_Intelligence\\TORCS-Self-Driving-Agent-master\\data_generation\\log.txt", true);
//			fw.write("Current Gear: " + currentGear + "\n");
//			fw.write("New Gear: " + gear + "\n");
//			fw.write("Clutch: " + clutch + "\n");
//			fw.close();
//        } catch (IOException e) {
